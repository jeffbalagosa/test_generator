...
# Split the raw data into individual term-definition pairs
pairs = raw_data.split("{-line_break-}")

# Initialize an empty list to store the parsed data
answer_key = []

# Iterate over each pair and split into term and definition
for pair in pairs:
    if "{-tab-}" in pair:
        term, definition = pair.split("{-tab-}")
        answer_key.append({"term": term, "definition": definition})

# Print the answer key to the console
print(answer_key)
